...
<body>
  <div class="ucc-blocker">
    ...
    function initTelemetry() {
        ...
        // v0.21: падение скрипта раньше выглядело снаружи как «просто не
        // работает» — ни следа, ни повода посмотреть в нужное место. Лимит на
        // загрузку нужен, чтобы сломанный сайт не забил журнал своими ошибками:
        // здесь ловятся все, отличить чужие от своих на этом уровне нельзя.
        let errorsSent = 0;
